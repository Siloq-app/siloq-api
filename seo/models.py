...
class SiteEntityProfile(models.Model):
    ...
    num_employees = models.CharField(max_length=100, blank=True)
    ...
    gbp_place_id = models.CharField(max_length=255, blank=True)
    gbp_synced_at = models.DateTimeField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
